var hljs = new function () {
  ...
  function s(n, r, i) {
    ...
    for (var u = 0, l = '', f = [
      ...
      if (l += e(i.substr(u, h[0].offset - u)), u = h[0].offset, h == n) {
        ...
        f.reverse().forEach(s)
      } else 'start' == h[0].event ? f.push(h[0].node)  : f.pop(),
      c(h.splice(0, 1) [0])
    }
  ...
  function o(e) {
    ...
    function r(a, s) {
      if (!a.compiled) {
        ...
        s && (a.bK && (a.b = '\\b(' + a.bK.split(' ').join('|') + ')\\b'), a.b || (a.b = /\B|\b/), a.bR = n(a.b), a.e || a.eW || (a.e = /\B|\b/), a.e && (a.eR = n(a.e)), a.tE = t(a.e) || '', a.eW && s.tE && (a.tE += (a.e ? '|' : '') + s.tE)),
        a.i && (a.iR = n(a.i)),
        void 0 === a.r && (a.r = 1),
        a.c || (a.c = [
        ]);
  ...
  function c(t, r, i, a) {
    ...
    o(x);
    for (var w = a || x, L = {
    }, M = '', k = w; k != x; k = k.parent) k.cN && (M = g(k.cN, '', !0) + M);
    var B = '',
    y = 0;
    try {
      for (var C, I, j = 0; ; ) {
        if (w.t.lastIndex = j, C = w.t.exec(r), !C) break;
        I = R(r.substr(j, C.index - j), C[0]),
        j = C.index + I
      }
      R(r.substr(j));
  ...
  function f(e, t, n) {
    ...
    return e.match(/(\s|^)hljs(\s|$)/) || i.push('hljs'),
    r && i.push(r),
    i.join(' ').trim()
  }
  function h(e) {
...
hljs.registerLanguage('less', function (e) {
  ...
  return a.push(e.CLCM, e.CBCM, C, d, p, l),
  {
    cI: !0,
    i: '[=>\'/<($"]',
    c: a
